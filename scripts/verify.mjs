...
assert.match(greetingListPage, /data-topogram-region="results"/);
assert.match(greetingListPage, /data-topogram-screen="greeting_list"/);
assert.match(greetingListPage, /data-topogram-display-field/);
assert.match(greetingListPage, /className="widget-card widget-table"/);
...
assert.equal(coverage.screens[0].widget_usages[0].markers.actual.widget, true);
assert.equal(coverage.screens[0].widget_usages[0].markers.actual.region, true);
assert.equal(coverage.screens[0].widget_usages[0].markers.actual.screen, true);
assert.equal(coverage.screens[0].widget_usages[0].display_fields_rendered, true);
assert.ok(coverage.screens[0].widget_usages[0].display_fields.length > 0);
